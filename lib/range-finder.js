...
function RangeFinder(gpioNo) {
  if (!(this instanceof RangeFinder)) {
    return new RangeFinder(gpioNo);
  }

  this._gpio = new Gpio(gpioNo, {
    mode: Gpio.OUTPUT,
  ...
  // As a single pin is used for both trigger and echo there will be alert
